...
M.barbar = {
  n = {
    ["L"] = { "<cmd>BufferNext<cr>", "Navigate to next through buffers" },
    ["H"] = { "<cmd>BufferPrevious<cr>", "Navigate to prev through buffers" },
    ["HH"] = { "<cmd>BufferMovePrevious<CR>", "Move buffer to prev position" },
    ["LL"] = { "<cmd>BufferMoveNext<CR>", "Move buffer to next position" }
